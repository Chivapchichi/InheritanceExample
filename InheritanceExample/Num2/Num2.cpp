...
class liveng : public creature
{
public:
    liveng() {};
    liveng(const liveng& obj) : creature(obj) {}
    liveng(const string& _name, double _mass, int _hp, int _DPS) : creature(_name, _mass, _hp, _DPS) {}
    virtual ~liveng()
    {
        cout << "liveng deleted" << endl;
    }
...
class mythical_animal : public liveng
{
private:
    bool Horrific_sight;
public:
    mythical_animal() {}
    mythical_animal(const mythical_animal& obj) : liveng(obj), Horrific_sight(obj.Horrific_sight) {}
    mythical_animal(const string& _name, double _mass, int _hp, int _DPS, bool _Horrific_sight) : liveng(_name, _mass, _hp, _DPS), Horrific_sight(_Horrific_sight) {}
...
class humanoid_character : public liveng
{
private:
    bool composure;
public:
    humanoid_character() {}
    humanoid_character(const humanoid_character& obj) : liveng(obj), composure(obj.composure) {}
    humanoid_character(const string& _name, double _mass, int _hp, int _DPS, bool _composure) : liveng(_name, _mass, _hp, _DPS), composure(_composure) {}
...
class magic_character : public liveng
{
private:
    bool wind_magic;
public:
    magic_character() {}
    magic_character(const magic_character& obj) : liveng(obj), wind_magic(obj.wind_magic) {}
    magic_character(const string& _name, double _mass, int _hp, int _DPS, bool _wind_magic) : liveng(_name, _mass, _hp, _DPS), wind_magic(_wind_magic) {}
